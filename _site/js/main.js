$(document).ready(function () {
  ...
  if (currentWidth < 960) {
    ...
    $( ".pdf-link" )
      .addClass( "visible" )
      .removeClass("hidden")
      .append( "<a href='/lorenzomonti/assets/pdf/resume.pdf' target='_blank'>Click here to see my resume.</a>" )
  ...
  if (window.location.pathname !== '/lorenzomonti/' && window.location.pathname !== '/lorenzomonti/index.html') {
    $('.panel-cover').addClass('panel-cover--collapsed')
  }
